...
//"SE84",1,0,0,0,0,0,0,
let dataroot=null
export function setDataRoot(droot){
  dataroot=droot
}
...
export function change_1930_1969_vs_2000_2019(identifier) {
...
export function bsbiHectadDateClassesNewest(identifier) {
  return bsbiHectadDateClasses(identifier, true, 'Date classes (newest on top)')
}
export function bsbiHectadDateClassesOldest(identifier) {
...
export function nativeSpeciesStatus(identifier) {
  //Native (n)
  //Alien (a)
...
export function bsbiHectadDateTetFreq(identifier) {
